          ...
          <div className="flex items-center lg:order-2">
            {user ? (
              ...
              <>
                <a
                  href={paths.signIn()}
                  className="mr-2 rounded-lg px-5 py-2.5 text-lg text-sm font-medium text-gray-600 hover:bg-gray-50 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-800"
                >
                  Log in
                </a>
                <a
