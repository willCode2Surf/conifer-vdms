import { Code, Lock, Settings, Zap } from 'react-feather';
    ...
    <>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="mx-auto max-w-screen-xl px-4 py-8 lg:py-16">
          <h2 className="mb-6 text-center text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white md:text-4xl">
            We use the best tools of the industry.
          </h2>
          <div className="mx-auto flex w-full justify-center gap-x-8 text-gray-500 dark:text-gray-400">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
            <div>
              <div className="bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
                <Lock className="text-primary-600 dark:text-primary-300 h-5 w-5 lg:h-6 lg:w-6" />
              </div>
            ...
            <div>
              <div className="bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
                <Zap className="text-primary-600 dark:text-primary-300 h-5 w-5 lg:h-6 lg:w-6" />
              </div>
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Ready to process millions of documents in a flash with the
                permissioning you expect.
              </p>
            </div>
            <div>
              <div className="bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                We cache your embeddings so you only pay once to embed your
                documents. Saving you a ton of money.
              </p>
            </div>
            <div>
              <div className="bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
                <Code className="text-primary-600 dark:text-primary-300 h-5 w-5 lg:h-6 lg:w-6" />
              </div>
              <h3 className="mb-2 text-xl font-bold dark:text-white">
                Developer Friendly
              </h3>
            ...
            <div>
              <div className="bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
                <Settings className="text-primary-600 dark:text-primary-300 h-5 w-5 lg:h-6 lg:w-6" />
              </div>
              <h3 className="mb-2 text-xl font-bold dark:text-white">
                Customizable
              </h3>
              <p className="text-gray-500 dark:text-gray-400">
                Organize your documents into a process that makes sense and
                works with your specific business. Conifer works with your
        ...
        <div className="mx-auto max-w-screen-xl">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-400 sm:text-center">
              ...
              <a href="https://mintplexlabs.com" className="hover:underline">
                Mintplex Labs Inc
              </a>
              . All Rights Reserved.
            </span>
